...
import {
    BATCH_SIZE,
    COLLECTION_NAME,
    prepareTypesenseAdvancedGenresData,
    TYPESENSE_ADVANCED_GENRE_SCHEMA,
} from "./schema/advancedGenre";

export const indexTypesenseAdvancedGenres = async () => {
    ...
    await client
        .collections()
        .create(TYPESENSE_ADVANCED_GENRE_SCHEMA(INDEX_NAME));
